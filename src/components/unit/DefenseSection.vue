  ...
  <tbody>
    <tr class="unit-details__firstline">
      <td :title="`${defense?.Health} hp`">
        <span class="icon_ui icon-health unit-details__ic"></span>{{ shorten(defense?.Health) }}
        <br>
      ...
      <td :title="economy?.BuildCostMass">
        <span class="icon_ui icon-mass unit-details__ic"></span>{{ shorten(economy?.BuildCostMass) }}
      </td>
      <td :title="economy?.BuildCostEnergy">
        <span class="icon_ui icon-energy unit-details__ic"></span>{{ shorten(economy?.BuildCostEnergy) }}
      </td>
      <td :title="economy?.BuildTime">
        <span class="icon_ui icon-time unit-details__ic"></span>{{ shorten(economy?.BuildTime) }}
      </td>
    </tr>
